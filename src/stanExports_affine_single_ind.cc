...
#include "stanExports_affine_single_ind.h"

RCPP_MODULE(stan_fit4affine_single_ind_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_affine_single_ind")
